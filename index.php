...
<div class="container mx-auto px-4">
    ...
    <?php foreach($users as $user): ?>
        <div class="card border-2 border-gray-300 rounded-lg p-2">
            <div class="h-12">
                <div class="relative">
                    <h1 class="absolute left-0 top-0 font-extrabold text-4xl right-0 text-gray-700">#<?php echo $user['id']; ?></h1>
                    <img class="absolute top-0 right-0 w-12 rounded-full border-4 border-purple-700" src="img/no-photo.jpg" alt="No user photo available">
                </div>
            </div>
            <div class="">
                <h3>Name</h3>
